...
var AlpacaModel = /** @class */ (function () {
    ...
    AlpacaModel.prototype.generateMongoose = function () {
        ...
        var schema = new mongoose_1.Schema(this.mongooseTemplate, schemaOptions);
        if (this.options.schemaCallback && validators_1.default.isValidFunction(this.options.schemaCallback)) {
    ...
    AlpacaModel.prototype.getTsProperties = function () {
        ...
        modelKeys.forEach(function (modelKey) {
            ...
            if (rawObject && rawObject.populate && rawObject.ref && validators_1.default.isValidName(rawObject.ref) && getModelByName(rawObject.ref.toLowerCase())) {
                ...
                if (isAlpacaArray) {
                    toWrite.properties[modelKey] = { items: modelHelpers_1.getTypeDefObject(type.primitive) };
                }
                else {
                    toWrite.properties[modelKey] = modelHelpers_1.getTypeDefObject(type.primitive);
                }
            }
